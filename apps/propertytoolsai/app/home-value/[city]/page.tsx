...
// ISR: warehouse figures refresh daily. Pre-render the largest metros at build;
// the long tail (counties/ZIPs/smaller metros) renders on demand and is cached.
...
export default async function HomeValueCityPage({
  ...
  const pageDescription = `Get a localized home value estimate for ${city.city}, ${city.state} with current market trends, days on market, and ${keywords[0]} guidance.`;
