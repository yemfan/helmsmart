  ...
  return (
    <div className="max-w-6xl mx-auto p-6 space-y-6">
        ...
        {property.photoUrl ? (
          <div className="h-32 w-full shrink-0 overflow-hidden rounded-xl border border-gray-200 bg-gray-100 md:w-48">
            ...
            <img
              ...
              alt={t("pages.property.photoAlt", { address: property.address })}
      ...
      <div className="bg-white shadow rounded-xl p-6 border border-gray-100">
        <h2 className="text-lg font-semibold text-gray-900 mb-3">{t("pages.articleChrome.comparableSales", { ns: "web_pages" })}</h2>
      ...
      <div className="bg-white shadow rounded-xl p-6 border border-gray-100">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 text-sm">
          <div className="bg-gray-50 rounded-lg p-3 text-center">
            <p className="text-xs text-gray-500 uppercase tracking-wide">{t("pages.articleChrome.capRate", { ns: "web_pages" })}</p>
            <p className="text-lg font-semibold text-gray-900">
              {investmentMetrics.capRate.toFixed(1)}%
            </p>
          </div>
          <div className="bg-gray-50 rounded-lg p-3 text-center">
            <p className="text-xs text-gray-500 uppercase tracking-wide">{t("pages.articleChrome.monthlyCashFlow", { ns: "web_pages" })}</p>
            <p className="text-lg font-semibold text-gray-900">
