...
export default function AgentHomeValueLeadsPage() {
  const { t, i18n } = useTranslation("web_pages");
            ...
            <table className="min-w-full text-xs border-collapse">
              <thead>
                <tr className="bg-gray-50 text-left text-gray-600">
                  <th className="px-3 py-2 font-semibold">{t("pages.articleChrome.name", { ns: "web_pages" })}</th>
                  <th className="px-3 py-2 font-semibold">{t("pages.articleChrome.address", { ns: "web_pages" })}</th>
                  <th className="px-3 py-2 font-semibold">{t("pages.articleChrome.email", { ns: "web_pages" })}</th>
                  <th className="px-3 py-2 font-semibold">{t("pages.articleChrome.phone", { ns: "web_pages" })}</th>
