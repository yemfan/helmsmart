  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-xl font-semibold text-slate-900 dark:text-slate-100">{clock.greeting}{greetingName ? `, ${greetingName}` : ""}</h1>
      ...
      {stats && (
        <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
          <Link href="/dashboard/leads" className="rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 p-4 shadow-sm hover:bg-slate-50 dark:hover:bg-slate-800 transition">
            <p className="text-xs text-slate-500">{t("pages.overview.totalLeads")}</p>
            <p className="mt-1 text-2xl font-bold text-slate-900 dark:text-slate-100">{stats.totalLeads}</p>
          </Link>
          <Link href="/dashboard/leads?filter=hot" className="rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 p-4 shadow-sm hover:bg-slate-50 dark:hover:bg-slate-800 transition">
          ...
          <Link href="/dashboard/inbox" className="rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 p-4 shadow-sm hover:bg-slate-50 dark:hover:bg-slate-800 transition">
            <p className="text-xs text-slate-500">{t("pages.overview.messagesSent")}</p>
            <p className="mt-1 text-2xl font-bold text-slate-900 dark:text-slate-100">{stats.messagesSent}</p>
          </Link>
      ...
      <div className="grid gap-4 lg:grid-cols-2">
        ...
        <div className="rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 p-4 shadow-sm">
          <div className="flex items-center justify-between mb-3">
            <h2 className="text-sm font-semibold text-slate-900 dark:text-slate-100">{t("pages.overview.todaysSchedule")}</h2>
          ...
          {events.length === 0 ? (
            ...
            <div className="space-y-2">
              {events.map((e) => (
                <div key={e.id} className="flex items-center justify-between rounded-lg border border-slate-100 dark:border-slate-700 px-3 py-2">
                  <div>
        ...
        <div className="rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 p-4 shadow-sm">
          <div className="flex items-center justify-between mb-3">
            <h2 className="text-sm font-semibold text-slate-900 dark:text-slate-100">{t("pages.overview.openTasks")}</h2>
          ...
          {tasks.length === 0 ? (
            ...
            <div className="space-y-2">
              {tasks.slice(0, 5).map((t) => (
                <div key={t.id} className="flex items-center justify-between rounded-lg border border-slate-100 dark:border-slate-700 px-3 py-2">
                  <div>
                  ...
                  <span className={`rounded-full px-2 py-0.5 text-[10px] font-medium capitalize ${t.priority === "urgent" ? "bg-red-100 text-red-700" : t.priority === "high" ? "bg-amber-100 text-amber-700" : "bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-400"}`}>
                    {t.priority}
                  </span>
                </div>
              ))}
      ...
      {/* Quick Actions */}
      <div className="rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 p-4 shadow-sm">
        <h2 className="text-sm font-semibold text-slate-900 dark:text-slate-100 mb-3">{t("pages.overview.quickActions")}</h2>
        <div className="grid grid-cols-2 gap-2 sm:grid-cols-4">
          <Link href="/dashboard/leads/add" className="rounded-lg border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-900/60 px-3 py-3 text-center text-xs font-medium text-slate-700 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800 transition">{t("pages.overview.addContact")}</Link>
          <Link href="/dashboard/contacts/scan" className="rounded-lg border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-900/60 px-3 py-3 text-center text-xs font-medium text-slate-700 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800 transition">{t("pages.overview.scanCard")}</Link>
          <Link href="/dashboard/open-houses/flyer" className="rounded-lg border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-900/60 px-3 py-3 text-center text-xs font-medium text-slate-700 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800 transition">{t("pages.overview.createFlyer")}</Link>
          <Link href="/dashboard/seller-presentation" className="rounded-lg border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-900/60 px-3 py-3 text-center text-xs font-medium text-slate-700 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800 transition">{t("pages.overview.sellerPresentation")}</Link>
        </div>
      </div>
