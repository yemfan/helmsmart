  ...
  return (
    <main className="mx-auto max-w-5xl px-4 py-8">
      <header className="mb-6 max-w-2xl">
        <h1 className="text-2xl font-bold tracking-tight text-slate-900 dark:text-slate-100">{t("pages.cmaPage.title", { ns: "dashboard" })}</h1>
        <p className="mt-2 text-sm text-slate-600 dark:text-slate-400">{t("pages.cmaPage.sub", { ns: "dashboard" })}</p>
      </header>
