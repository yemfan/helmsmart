...
export function SendClient({ agent }: { agent: string }) {
  ...
  return (
    <div className="space-y-5">
      ...
      <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-xl shadow-sm p-4 space-y-4">
        ...
        <div className="flex items-center justify-between gap-3 flex-wrap">
          <label className="inline-flex items-center gap-2 text-xs text-brand-text">
            <input
              ...
              className="h-3.5 w-3.5 rounded border-slate-300 dark:border-slate-700 text-brand-primary focus:ring-brand-primary"
            />
          ...
          <div className="space-y-2 mt-2">
            ...
            <div className="flex flex-col sm:flex-row gap-2">
              <input
                ...
                readOnly
                value={generatedLink}
                className="flex-1 border border-slate-300 dark:border-slate-700 rounded-lg px-3 py-2 text-xs font-mono bg-brand-surface text-brand-text"
              />
              <button
                type="button"
                onClick={handleCopy}
              ...
              <button
                ...
                className="inline-flex items-center justify-center bg-white dark:bg-slate-900 text-brand-text border border-slate-300 dark:border-slate-700 text-xs font-semibold px-4 py-2 rounded-lg hover:bg-brand-surface"
