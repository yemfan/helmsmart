          ...
          return (
            ...
            >
              ...
              <div className="flex gap-4 items-center">
                <div className="bg-brand-surface border border-slate-200 rounded-lg p-2">
                ...
                <div className="flex-1 space-y-2">
                  ...
                  <input
                    readOnly
                    value={signupUrl}
                    className="w-full text-xs font-mono px-3 py-2 rounded-lg border border-slate-300 bg-brand-surface text-brand-text"
                  />
                  <div className="flex gap-2 flex-wrap">
                    ...
                    <button
                      type="button"
                      className="text-xs font-semibold px-3 py-2 rounded-lg bg-white border border-slate-300 text-brand-text hover:bg-brand-surface"
