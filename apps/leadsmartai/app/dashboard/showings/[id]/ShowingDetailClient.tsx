            ...
            <div className="flex flex-wrap gap-2">
              {(["scheduled", "attended", "cancelled", "no_show"] as ShowingStatus[]).map((s) => (
                <button
                  ...
                  className={`rounded-lg border px-3 py-1.5 text-sm ${ status === s ? "border-slate-900 bg-[#0072ce] text-white" : "border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 text-slate-700 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-800" } disabled:opacity-60`}
                >
                  {STATUS_LABEL[s]}
                </button>
              ))}
