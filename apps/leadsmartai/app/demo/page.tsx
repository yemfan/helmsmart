  ...
  return (
    <DemoShell active="/demo">
      <div className="space-y-6">
        <header>
          <h1 className="text-2xl font-semibold tracking-tight text-slate-900 dark:text-white">{t("pages.demoPages.greeting", { ns: "web_pages" })}</h1>
          <p className="mt-1 text-sm text-slate-500 dark:text-slate-400">
            ...
            · {t("pages.demoPages.sandbox", { ns: "web_pages" })}
          </p>
        </header>
        ...
        <div className="flex flex-wrap gap-2">
          <span className="rounded-lg border border-red-200 bg-red-50 px-3 py-2 text-xs font-medium text-red-700 dark:border-red-900/40 dark:bg-red-950/30 dark:text-red-300">
            {t("pages.demoPages.alertEscalatedDrafts", { ns: "web_pages", n: 2 })}
          </span>
          <span className="rounded-lg border border-blue-200 bg-blue-50 px-3 py-2 text-xs font-medium text-blue-700 dark:border-blue-900/40 dark:bg-blue-950/30 dark:text-blue-300">
            {t("pages.demoPages.alertUnread", { ns: "web_pages", n: 3 })}
          </span>
          <span className="rounded-lg border border-amber-200 bg-amber-50 px-3 py-2 text-xs font-medium text-amber-700 dark:border-amber-900/40 dark:bg-amber-950/30 dark:text-amber-300">
            {t("pages.demoPages.alertUrgentTasks", { ns: "web_pages", n: 2 })}
          </span>
        </div>

        {/* Briefings */}
        <section>
          <h2 className="text-sm font-semibold uppercase tracking-wider text-slate-500 dark:text-slate-400">{t("pages.demoPages.thisMorning", { ns: "web_pages" })}</h2>
        ...
        <section className="grid grid-cols-2 gap-3 md:grid-cols-4">
          <KpiTile
            label={t("pages.demoPages.newLeadsToday", { ns: "web_pages" })}
            value={DEMO_KPIS.newLeadsToday.toString()}
            tone="blue"
            sub={t("pages.demoPages.kpiSubNewLeads", { ns: "web_pages" })}
          />
          <KpiTile
            label={t("pages.demoPages.hotLeads", { ns: "web_pages" })}
            value={DEMO_KPIS.hotLeads.toString()}
            tone="orange"
            sub={t("pages.demoPages.kpiSubHotLeads", { ns: "web_pages" })}
          />
          <KpiTile
            label={t("pages.demoPages.messagesSent", { ns: "web_pages" })}
            value={DEMO_KPIS.messagesSent.toString()}
            tone="violet"
            sub={t("pages.demoPages.kpiSubMessagesSent", { ns: "web_pages" })}
          />
          <KpiTile
            label={t("pages.demoPages.quietLeads", { ns: "web_pages" })}
            value={DEMO_KPIS.quietLeads.toString()}
            tone="amber"
            sub={t("pages.demoPages.kpiSubQuietLeads", { ns: "web_pages" })}
          />
        </section>
        ...
        <section className="grid gap-4 lg:grid-cols-3">
          <article className="rounded-2xl border border-slate-200 bg-white p-5 dark:border-slate-800 dark:bg-slate-900">
            <div className="flex items-center gap-2 text-xs font-semibold uppercase tracking-wider text-slate-500 dark:text-slate-400">
              <Clock className="h-3.5 w-3.5" aria-hidden />{t("pages.demoPages.medianResponse", { ns: "web_pages" })}</div>
            <p className="mt-2 font-heading text-3xl font-bold text-slate-900 dark:text-white">
              {DEMO_KPIS.weeklyResponseTimeSec}
              <span className="text-base font-medium text-slate-500">
                {" "}
                {t("pages.demoPages.secondsUnit", { ns: "web_pages" })}
              </span>
            </p>
            <p className="mt-1 text-xs text-slate-500 dark:text-slate-400">{t("pages.dashFragments.thisWeekCombined", { ns: "dashboard" })}{" "}
              <span className="font-semibold text-emerald-600">
                {t("pages.demoPages.responseDelta", { ns: "web_pages" })}
              </span>
            </p>
          </article>
          <article className="rounded-2xl border border-slate-200 bg-white p-5 dark:border-slate-800 dark:bg-slate-900">
            <div className="flex items-center gap-2 text-xs font-semibold uppercase tracking-wider text-slate-500 dark:text-slate-400">
              <Sparkles className="h-3.5 w-3.5" aria-hidden />{t("pages.demoPages.toursBooked", { ns: "web_pages" })}</div>
            <p className="mt-2 font-heading text-3xl font-bold text-slate-900 dark:text-white">
              {DEMO_KPIS.weeklyTours}
            </p>
            <p className="mt-1 text-xs text-slate-500 dark:text-slate-400">
              {t("pages.demoPages.toursSub", { ns: "web_pages" })}
            </p>
          </article>
          <article className="rounded-2xl border border-slate-200 bg-white p-5 dark:border-slate-800 dark:bg-slate-900">
            <div className="flex items-center gap-2 text-xs font-semibold uppercase tracking-wider text-slate-500 dark:text-slate-400">
              <Phone className="h-3.5 w-3.5" aria-hidden />{t("pages.demoPages.voiceCalls", { ns: "web_pages" })}</div>
            <p className="mt-2 font-heading text-3xl font-bold text-slate-900 dark:text-white">
              11
            </p>
            <p className="mt-1 text-xs text-slate-500 dark:text-slate-400">
              {t("pages.demoPages.voiceCallsSub", { ns: "web_pages" })}
            </p>
          </article>
        </section>
        ...
        <section className="grid gap-4 lg:grid-cols-2">
          <article className="rounded-2xl border border-slate-200 bg-white p-5 dark:border-slate-800 dark:bg-slate-900">
            <div className="flex items-center justify-between">
              <h2 className="text-sm font-semibold uppercase tracking-wider text-slate-500 dark:text-slate-400">{t("pages.demoPages.upcoming", { ns: "web_pages" })}</h2>
              <Link
                href="/demo/calendar"
                className="text-xs font-semibold text-blue-700 dark:text-blue-300"
              >
                {t("pages.demoPage.openCalendar", { ns: "web_pages" })}
              </Link>
            </div>
          ...
          <article className="rounded-2xl border border-slate-200 bg-white p-5 dark:border-slate-800 dark:bg-slate-900">
            <div className="flex items-center justify-between">
              <h2 className="text-sm font-semibold uppercase tracking-wider text-slate-500 dark:text-slate-400">{t("pages.demoPages.tasks", { ns: "web_pages" })}</h2>
              <DemoDisabledButton label={t("pages.demoPages.addTask", { ns: "web_pages" })} variant="ghost" />
            </div>
            <ul className="mt-3 space-y-2">
  ...
  return (
    <section className="rounded-3xl border border-blue-100 bg-gradient-to-br from-blue-50 via-white to-white p-6 md:p-8 dark:border-blue-900/40 dark:from-blue-950/30 dark:via-slate-950 dark:to-slate-950">
      <div className="flex flex-wrap items-center justify-between gap-4">
        <div>
          <p className="text-xs font-semibold uppercase tracking-[0.18em] text-blue-700 dark:text-blue-300">{t("pages.demoPages.likeIt", { ns: "web_pages" })}</p>
          <h2 className="mt-1 text-xl font-semibold tracking-tight text-slate-900 md:text-2xl dark:text-white">{t("pages.demoPages.dayOne", { ns: "web_pages" })}</h2>
          <p className="mt-1 text-sm text-slate-600 dark:text-slate-300">
            {t("pages.demoPages.trialFinePrint", { ns: "web_pages" })}
          </p>
        </div>
        <div className="flex flex-wrap gap-2">
          <Link
          ...
          >{t("pages.demoPages.startTrial", { ns: "web_pages" })}<ArrowRight className="ml-1.5 h-4 w-4" aria-hidden />
          </Link>
          <Link
            href="/agent/compare"
          ...
          >{t("pages.demoPages.compareCrm", { ns: "web_pages" })}</Link>
        </div>
      </div>
    </section>
  );
