...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    title: t("pages.demoPages.metaCalendarTitle", { ns: "web_pages" }),
    description: t("pages.demoPages.metaCalendarDescription", { ns: "web_pages" }),
  ...
  return (
    <DemoShell active="/demo/calendar">
      <header className="mb-5 flex flex-wrap items-end justify-between gap-3">
        <div>
          <h1 className="text-2xl font-semibold tracking-tight text-slate-900 dark:text-white">{t("pages.demoPages.calendar", { ns: "web_pages" })}</h1>
        ...
        <div className="flex flex-wrap gap-2">
          <DemoDisabledButton label={t("pages.demoPages.connectGoogle", { ns: "web_pages" })} variant="ghost" />
          <DemoDisabledButton label={t("pages.demoPages.newEvent", { ns: "web_pages" })} />
        </div>
      </header>

      <div className="grid gap-4 lg:grid-cols-[1.4fr_1fr]">
        <section className="rounded-2xl border border-slate-200 bg-white p-5 dark:border-slate-800 dark:bg-slate-900">
          <h2 className="text-sm font-semibold uppercase tracking-wider text-slate-500 dark:text-slate-400">{t("pages.demoPages.upcomingEvents", { ns: "web_pages" })}</h2>
        ...
        <section className="rounded-2xl border border-slate-200 bg-white p-5 dark:border-slate-800 dark:bg-slate-900">
          <h2 className="text-sm font-semibold uppercase tracking-wider text-slate-500 dark:text-slate-400">{t("pages.demoPages.activeDeals", { ns: "web_pages" })}</h2>
          <ul className="mt-3 space-y-3">
