...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    title: t("pages.demoPages.metaInboxTitle", { ns: "web_pages" }),
    description: t("pages.demoPages.metaInboxDescription", { ns: "web_pages" }),
  ...
  return (
    <DemoShell active="/demo/inbox">
      <header className="mb-4 flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-semibold tracking-tight text-slate-900 dark:text-white">{t("pages.demoPages.inbox", { ns: "web_pages" })}</h1>
        ...
        <DemoDisabledButton label={t("pages.demoPages.compose", { ns: "web_pages" })} />
      </header>
      ...
      <div className="grid gap-4 lg:grid-cols-[minmax(280px,360px)_minmax(0,1fr)]">
        ...
        <aside className="overflow-hidden rounded-2xl border border-slate-200 bg-white dark:border-slate-800 dark:bg-slate-900">
          <div className="flex items-center justify-between border-b border-slate-100 px-4 py-3 dark:border-slate-800">
            <p className="text-xs font-semibold uppercase tracking-wider text-slate-500 dark:text-slate-400">{t("pages.demoPages.needsReply", { ns: "web_pages" })}</p>
            <p className="text-[10px] font-medium text-slate-400">{t("pages.demoPages.autoSorted", { ns: "web_pages" })}</p>
          </div>
          ...
          <header className="border-b border-slate-100 px-5 py-4 dark:border-slate-800">
            <div className="flex flex-wrap items-start justify-between gap-2">
              ...
              <div className="flex flex-wrap gap-1.5">
                <DemoDisabledButton label={t("pages.demoPages.call", { ns: "web_pages" })} variant="ghost" />
                <DemoDisabledButton label={t("pages.demoPages.videoEmail", { ns: "web_pages" })} variant="ghost" />
                <DemoDisabledButton label={t("pages.demoPages.addToDeal", { ns: "web_pages" })} variant="ghost" />
              </div>
            </div>
          </header>
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                <p className="text-[11px] font-semibold uppercase tracking-wider text-blue-700 dark:text-blue-300">
                  {t("pages.demoPages.aiSuggestionReady", { ns: "web_pages" })}
                </p>
                ...
                <div className="mt-3 flex flex-wrap gap-2">
                  ...
                  <DemoDisabledButton label={t("pages.demoPages.edit", { ns: "web_pages" })} variant="ghost" />
...
function formatAgo(
  ...
  if (min < 60) return t("pages.demoPages.agoMinutes", { ns: "web_pages", n: min });
  const hr = Math.floor(min / 60);
  if (hr < 24) return t("pages.demoPages.agoHours", { ns: "web_pages", n: hr });
  const day = Math.floor(hr / 24);
  return t("pages.demoPages.agoDays", { ns: "web_pages", n: day });
}
