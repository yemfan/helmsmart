...
export default async function DataCenterPage() {
  ...
  return (
    <main className="bg-white text-slate-900">
      ...
      <section className="border-b border-slate-100 bg-gradient-to-b from-slate-50 to-white">
        <div className="mx-auto max-w-7xl px-6 py-16 md:py-20">
          ...
          <div className="max-w-3xl">
            ...
            <h1 className="text-4xl font-bold leading-tight tracking-tight md:text-5xl">{t("pages.dataCenterPages.heroTitle", { ns: "dashboard" })}</h1>
            <p className="mt-6 max-w-2xl text-lg leading-8 text-slate-600">{t("pages.dataCenterPages.heroBody", { ns: "dashboard" })}</p>
          </div>
        </div>
      </section>

      {/* Reports list */}
      <section className="mx-auto max-w-7xl px-6 py-14 md:py-16" aria-label={t("pages.dataCenterPages.researchAria", { ns: "dashboard" })}>
        <div className="mb-6 flex items-baseline justify-between gap-4">
          <h2 className="text-2xl font-semibold tracking-tight md:text-3xl">{t("pages.dataCenterPages.researchTitle", { ns: "dashboard" })}</h2>
          <span className="text-sm text-slate-500">{t("pages.dataCenterPages.newestFirst", { ns: "dashboard" })}</span>
        </div>

        {reports.length === 0 ? (
          <div className="rounded-2xl border border-dashed border-slate-300 bg-white p-8 text-center">
            <p className="text-slate-600">{t("pages.dataCenterPages.reportsComing", { ns: "dashboard" })}</p>
          </div>
        ) : (
      ...
      <section className="bg-slate-50/80" aria-label={t("pages.dataCenterPages.exploreAria", { ns: "dashboard" })}>
        <div className="mx-auto max-w-7xl px-6 py-14 md:py-16">
          ...
          >
            <p className="inline-flex rounded-full bg-[#0072ce]/10 px-2.5 py-1 text-xs font-semibold uppercase tracking-wide text-[#0072ce]">{t("pages.dataCenterPages.localData", { ns: "dashboard" })}</p>
