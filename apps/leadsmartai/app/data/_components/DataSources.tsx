...
export default async function DataSources() {
  ...
  return (
    <section aria-label={t("pages.articleChrome.sources", { ns: "web_pages" })} className="space-y-3 border-t border-slate-200 pt-8">
      <h2 className="text-lg font-bold text-slate-900">{t("pages.dataCenterPages.sourcesTitle", { ns: "web_pages" })}</h2>
      <p className="text-sm text-slate-500">{t("pages.dataCenterPages.sourcesBody", { ns: "web_pages" })}</p>
