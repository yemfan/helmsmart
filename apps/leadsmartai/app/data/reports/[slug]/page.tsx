    ...
    <main className="bg-white text-slate-900">
      ...
      <article className="mx-auto max-w-3xl px-6 py-12 space-y-10">
        <nav className="text-sm">
          ...
          <span className="mx-2 text-slate-400">/</span>
          <span className="text-slate-600">{t("pages.dataCenterPages.report", { ns: "web_pages" })}</span>
        </nav>
        ...
        {keyStats.length > 0 && (
          <section aria-label={t("pages.dataCenterPages.keyStatsAria", { ns: "web_pages" })} className="grid gap-3 sm:grid-cols-2">
            {keyStats.map((stat, i) => {
        ...
        {dataTable && (
          <section aria-label={t("pages.dataCenterPages.dataTableAria", { ns: "web_pages" })} className="space-y-2">
        ...
        <section aria-label={t("pages.dataCenterPages.analysisAria", { ns: "web_pages" })} className="space-y-8">
          {sections.map((sec, i) => (
        ...
        {faqs.length > 0 && (
          <section aria-label={t("pages.articleChrome.faq", { ns: "web_pages" })} className="space-y-4">
            <h2 className="text-xl font-bold tracking-tight text-slate-900">{t("pages.articleChrome.faq", { ns: "web_pages" })}</h2>
        ...
        {sources.length > 0 && (
          <section aria-label={t("pages.articleChrome.sources", { ns: "web_pages" })} className="space-y-3 border-t border-slate-200 pt-8">
            <h2 className="text-lg font-bold tracking-tight text-slate-900">{t("pages.articleChrome.sources", { ns: "web_pages" })}</h2>
            <p className="text-sm text-slate-500">{t("pages.dataCenterPages.citation", { ns: "web_pages" })}</p>
