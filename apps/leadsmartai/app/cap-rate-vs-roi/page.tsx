...
export default function CapRateVsRoiPage() {
  const { t } = useTranslation("web_pages");
  ...
  return (
    <div className="container mx-auto px-4 py-10">
      ...
      >
        ...
        </svg>{t("pages.articles.backHome", { ns: "web_pages" })}</Link>

      <h1 className="text-3xl font-bold text-blue-600 mb-3">{title}</h1>
      <p className="text-gray-600 mb-8 max-w-3xl">{t("pages.capRateVsRoi.intro", { ns: "web_pages" })}</p>

      <section className="max-w-3xl space-y-4 text-sm text-gray-800">
        <h2 className="text-xl font-semibold text-gray-900">{t("pages.capRateVsRoi.whatIsCapRate", { ns: "web_pages" })}</h2>
        <p>{t("pages.capRateVsRoi.capRateDef", { ns: "web_pages" })}</p>
        ...
        <p>{t("pages.capRateVsRoi.capRateProperty", { ns: "web_pages" })}</p>
      </section>

      <section className="mt-8 max-w-3xl space-y-4 text-sm text-gray-800">
        <h2 className="text-xl font-semibold text-gray-900">{t("pages.capRateVsRoi.whatIsRoi", { ns: "web_pages" })}</h2>
        <p>{t("pages.capRateVsRoi.roiDef", { ns: "web_pages" })}</p>
        <p className="font-mono text-xs bg-gray-50 border border-gray-200 rounded-md p-3">
          ROI = (Total Profit ÷ Total Cash Invested) × 100%
        </p>
        <p>{t("pages.capRateVsRoi.roiInvestor", { ns: "web_pages" })}</p>
      </section>

      <section className="mt-8 max-w-3xl space-y-4 text-sm text-gray-800">
        <h2 className="text-xl font-semibold text-gray-900">{t("pages.capRateVsRoi.keyDifferences", { ns: "web_pages" })}</h2>
        <p>{t("pages.capRateVsRoi.bothMetrics", { ns: "web_pages" })}</p>
        <ul className="list-disc list-inside space-y-1">
          <li>
            <span className="font-semibold">{t("pages.capRateVsRoi.capRateLabel", { ns: "web_pages" })}</span>{t("pages.capRateVsRoi.capRateBullet", { ns: "web_pages" })}</li>
          <li>
            <span className="font-semibold">{t("pages.capRateVsRoi.roiLabel", { ns: "web_pages" })}</span>{t("pages.capRateVsRoi.roiBullet", { ns: "web_pages" })}</li>
        </ul>
        <p>{t("pages.capRateVsRoi.thinkOf", { ns: "web_pages" })}</p>
      </section>

      <section className="mt-8 max-w-3xl space-y-4 text-sm text-gray-800">
        <h2 className="text-xl font-semibold text-gray-900">{t("pages.capRateVsRoi.exampleTitle", { ns: "web_pages" })}</h2>
        <p>
        ...
        <p>{t("pages.capRateVsRoi.nowCompare", { ns: "web_pages" })}</p>
        <ul className="list-disc list-inside space-y-1">
          <li>
            <span className="font-semibold">{t("pages.capRateVsRoi.investorA", { ns: "web_pages" })}</span> buys all-cash, investing $300,000 of
            their own money.
          </li>
          <li>
            <span className="font-semibold">{t("pages.capRateVsRoi.investorB", { ns: "web_pages" })}</span> uses a 25% down payment ($75,000)
            and finances the rest with a mortgage.
          </li>
        </ul>
        <p>{t("pages.capRateVsRoi.exampleBody", { ns: "web_pages" })}</p>
      </section>

      <section className="mt-8 max-w-3xl space-y-4 text-sm text-gray-800">
        <h2 className="text-xl font-semibold text-gray-900">{t("pages.capRateVsRoi.whenToUse", { ns: "web_pages" })}</h2>
        <p>{t("pages.capRateVsRoi.inPractice", { ns: "web_pages" })}</p>
        <h3 className="text-lg font-semibold text-gray-900">{t("pages.capRateVsRoi.useCapWhen", { ns: "web_pages" })}</h3>
        <ul className="list-disc list-inside space-y-1">
          <li>{t("pages.capRateVsRoi.useCap1", { ns: "web_pages" })}</li>
          <li>{t("pages.capRateVsRoi.useCap2", { ns: "web_pages" })}</li>
          <li>{t("pages.capRateVsRoi.useCap3", { ns: "web_pages" })}</li>
          <li>{t("pages.capRateVsRoi.useCap4", { ns: "web_pages" })}</li>
        </ul>
        <h3 className="text-lg font-semibold text-gray-900 mt-4">{t("pages.capRateVsRoi.useRoiWhen", { ns: "web_pages" })}</h3>
        <ul className="list-disc list-inside space-y-1">
          <li>{t("pages.capRateVsRoi.useRoi1", { ns: "web_pages" })}</li>
