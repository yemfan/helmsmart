...
import { setBossRecommendationStatus } from "@/lib/realtyboss/recommendations";

export const runtime = "nodejs";

/**
 * PATCH /api/dashboard/realtyboss/recommendations/[id]
...
export async function PATCH(
  ...
  try {
    ...
    console.error("PATCH /api/dashboard/realtyboss/recommendations/[id]:", err);
