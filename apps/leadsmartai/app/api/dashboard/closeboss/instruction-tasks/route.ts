...
import { executeBossAction } from "@/lib/closeboss/actions/execute";
import { BOSS_ACTIONS, isBossActionType, missingParams } from "@/lib/closeboss/actions/registry";
...
/**
 * PATCH /api/dashboard/closeboss/instruction-tasks
