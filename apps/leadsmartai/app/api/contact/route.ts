      ...
      return NextResponse.json(
        {
          ok: false,
          error:
            "We received your message but couldn't send the confirmation email right now. We'll still see it — please reach out at contact@closebossai.com if you need an immediate reply.",
          delivered: false,
        },
        { status: 502 },
      );
