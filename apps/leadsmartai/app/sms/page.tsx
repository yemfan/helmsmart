  ...
  return (
    <div className="mx-auto max-w-2xl px-4 py-16 sm:px-6">
      <div className="text-center">
        <h1 className="text-3xl font-bold tracking-tight text-slate-900 sm:text-4xl">{t("pages.smsOptIn.h1", { ns: "web_pages" })}</h1>
        <p className="mx-auto mt-3 max-w-xl text-base text-slate-600">{t("pages.smsOptIn.sub", { ns: "web_pages" })}</p>
      </div>
      ...
      <div className="mt-10 grid gap-8 md:grid-cols-2">
        ...
        <div className="space-y-4 text-sm leading-6 text-slate-700">
          <div>
            <h2 className="text-sm font-semibold uppercase tracking-wide text-slate-500">{t("pages.smsOptIn.aboutProgram", { ns: "web_pages" })}</h2>
            <p className="mt-2">
          ...
          <ul className="space-y-2">
            <li>
              <strong>{t("pages.smsOptIn.frequency", { ns: "web_pages" })}</strong> {t("pages.smsOptIn.frequencyTail", { ns: "web_pages" })}</li>
            <li>
              <strong>{t("pages.smsOptIn.rates", { ns: "web_pages" })}</strong> (charged by your
              mobile carrier).
            </li>
            <li>{t("pages.smsOptIn.reply", { ns: "web_pages" })} <strong>{t("pages.smsOptIn.stop", { ns: "web_pages" })}</strong> {t("pages.smsOptIn.toUnsubscribe", { ns: "web_pages" })}{" "}
              <strong>{t("pages.smsOptIn.help", { ns: "web_pages" })}</strong> {t("pages.smsOptIn.forHelpOrEmail", { ns: "web_pages" })}{" "}
              <a href="mailto:contact@closebossai.com" className="text-[#0072ce] hover:underline">
                contact@closebossai.com
              </a>
              .
            </li>
            <li>{t("pages.smsOptIn.notACondition", { ns: "web_pages" })}</li>
          </ul>
          <p className="text-xs text-slate-500">{t("pages.smsOptIn.bySubmitting", { ns: "web_pages" })}{" "}
            ...
            <Link href="/terms" className="text-[#0072ce] hover:underline">{t("pages.smsOptIn.termsLink", { ns: "web_pages" })}</Link>
