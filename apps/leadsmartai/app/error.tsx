  ...
  return (
    <div className="min-h-[50vh] bg-slate-50 px-4 py-16 text-slate-900">
      <div className="mx-auto max-w-md rounded-2xl border border-slate-200 bg-white p-8 shadow-lg">
        <h1 className="font-heading text-xl font-bold text-slate-900">{t("pages.articleChrome.somethingWrong", { ns: "web_pages" })}</h1>
        ...
        >{t("pages.articleChrome.tryAgain", { ns: "web_pages" })}</button>
      </div>
    </div>
  );
}
