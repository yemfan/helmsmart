...
const CATEGORIES: Category[] = [
  ...
  },
  {
    ...
    icon: Mic,
    items: [
      { key: "retell", status: "live" },
      { key: "elevenlabs", status: "beta" },
    ],
  },
  {
    id: "media",
    ...
    items: [
      { key: "fal", status: "live" },
      { key: "seedance", status: "live" },
      { key: "wizper", status: "live" },
      { key: "lipsync", status: "beta" },
      { key: "remotion", status: "live" },
      { key: "kling", status: "beta" },
      { key: "veo", status: "coming-soon" },
    ],
  },
  {
    id: "social",
    ...
    icon: Share2,
    items: [
      { key: "meta", status: "live" },
      { key: "linkedin", status: "live" },
      { key: "threads", status: "live" },
      { key: "pinterest", status: "live" },
      { key: "tiktok", status: "beta" },
      { key: "youtube", status: "beta" },
    ],
  },
  {
    id: "esignature",
