  ...
  return (
    <main className="mx-auto max-w-6xl space-y-12 px-4 py-10 sm:px-6 sm:py-14">
      ...
      <section className="rounded-2xl border border-slate-200 bg-slate-50 p-6 text-sm text-slate-700">
        <h3 className="text-base font-semibold text-slate-900">{t("pages.articleChrome.faq", { ns: "web_pages" })}</h3>
        <dl className="mt-4 grid gap-5 sm:grid-cols-2">
          <div>
            <dt className="font-semibold text-slate-900">{t("pages.voiceTestDrive.q1", { ns: "web_pages" })}</dt>
            <dd className="mt-1 text-slate-700">{t("pages.voiceTestDrive.a1", { ns: "web_pages" })}</dd>
          </div>
          <div>
            <dt className="font-semibold text-slate-900">{t("pages.voiceTestDrive.q2", { ns: "web_pages" })}</dt>
            <dd className="mt-1 text-slate-700">{t("pages.voiceTestDrive.a2", { ns: "web_pages" })}</dd>
          </div>
          <div>
            <dt className="font-semibold text-slate-900">{t("pages.voiceTestDrive.q3", { ns: "web_pages" })}</dt>
            <dd className="mt-1 text-slate-700">{t("pages.voiceTestDrive.a3", { ns: "web_pages" })}</dd>
          </div>
          <div>
            <dt className="font-semibold text-slate-900">{t("pages.voiceTestDrive.q4", { ns: "web_pages" })}</dt>
            <dd className="mt-1 text-slate-700">{t("pages.voiceTestDrive.a4", { ns: "web_pages" })}</dd>
          </div>
        </dl>
      </section>
    </main>
