...
export default async function MarketReportKeywordPage({
  ...
  return (
    <main className="mx-auto max-w-5xl px-4 py-10">
      ...
      <p className="mt-2 text-slate-700">{t("pages.keywordPages.marketReportFor", { ns: "web_pages" })} {city.city}, {city.state}, built for long-tail SEO intent.
      </p>
      ...
      {(market.typicalValue !== null ||
        ...
        <div className="mt-6 grid gap-4 sm:grid-cols-3">
          ...
          {market.yoyChangePct !== null && (
            <Metric
              label={t("pages.keywordPages.annualTrend", { ns: "web_pages" })}
      ...
      <section className="mt-8 grid gap-6 md:grid-cols-[1.2fr_0.8fr]">
        <article className="rounded-2xl border border-slate-200 bg-white p-6">
          ...
          <div className="mt-2 flex flex-wrap gap-3 text-sm">
            <a href={`/home-value/${city.slug}/${p.keyword}`} className="text-blue-700 hover:underline">{t("pages.keywordPages.homeValueKeyword", { ns: "web_pages" })}</a>
        ...
        <LocalSeoLeadForm title={t("pages.seoCityPages.mrFormTitle", { ns: "web_pages", city: city.city })} source="seo_market_report_keyword" city={city.city} />
      </section>
    </main>
  );
}
