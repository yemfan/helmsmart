...
export default async function DataDeletionStatusPage({ params }: PageProps) {
  ...
  return (
    <div className="mx-auto max-w-2xl px-6 py-16">
      <h1 className="text-2xl font-semibold text-slate-900">{t("pages.dataCenterPages.deletionTitle", { ns: "web_pages" })}</h1>

      {isValidShape ? (
        <>
          <p className="mt-3 text-sm text-slate-600">{t("pages.dataCenterPages.deletionReceived", { ns: "web_pages" })}</p>
          ...
          <div className="mt-6 rounded-xl border border-emerald-200 bg-emerald-50 px-4 py-3">
            <p className="text-sm font-semibold text-emerald-900">{t("pages.dataCenterPages.deletionPending", { ns: "web_pages" })}</p>
            <p className="mt-1 text-sm text-emerald-800">
              {t("pages.dataCenterPages.deletionLogged", { ns: "web_pages" })}{" "}
              <a
                href="/privacy"
        ...
        <div className="mt-6 rounded-xl border border-amber-200 bg-amber-50 px-4 py-3">
          <p className="text-sm font-semibold text-amber-900">{t("pages.dataCenterPages.deletionUnknown", { ns: "web_pages" })}</p>
          <p className="mt-1 text-sm text-amber-800">{t("pages.dataCenterPages.deletionUnknownBody", { ns: "web_pages" })}<em>{t("pages.dataCenterPages.deletionAppsLink", { ns: "web_pages" })}</em>{t("pages.dataCenterPages.deletionSettings", { ns: "web_pages" })}{" "}
            <a
      ...
      <p className="mt-8 text-xs text-slate-500">
        {t("pages.dataCenterPages.deletionQuestions", { ns: "web_pages" })}{" "}
        <a
          href="mailto:contact@closebossai.com"
        ...
        {t("pages.dataCenterPages.deletionWithCode", { ns: "web_pages" })}
      </p>
    </div>
  );
}
