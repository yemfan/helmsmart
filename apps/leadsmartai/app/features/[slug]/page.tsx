    ...
    <>
      ...
      <section className="relative overflow-hidden border-b border-slate-200/70 bg-gradient-to-b from-slate-50 via-white to-white px-6 py-20 dark:border-slate-800 dark:from-slate-950 dark:via-slate-950 dark:to-slate-900 md:py-24">
        ...
        <div className="relative mx-auto max-w-3xl text-center">
          ...
          <nav className="mb-6 text-sm text-slate-500 dark:text-slate-400" aria-label={t("pages.articleChrome.breadcrumb", { ns: "web_pages" })}>
            <Link href="/features" className="hover:text-[#0072ce] hover:underline">{t("pages.featurePages.features", { ns: "web_pages" })}</Link>
          ...
          <div className="mt-9 flex flex-wrap items-center justify-center gap-3">
            ...
            >{t("pages.featurePages.startFree", { ns: "web_pages" })}<ArrowRight size={18} aria-hidden />
            </Link>
            <Link
              href="/contact"
            ...
            >{t("pages.featurePages.talkToUs", { ns: "web_pages" })}</Link>
          </div>
        </div>
      </section>
      ...
      <section className="px-6 py-18 md:py-20">
        <div className="mx-auto max-w-4xl">
          <h2 className="text-center font-heading text-2xl font-bold text-slate-900 md:text-3xl dark:text-white">{t("pages.featurePages.what", { ns: "web_pages" })} {feature.name} {t("pages.featurePages.doesForYou", { ns: "web_pages" })}</h2>
      ...
      <section className="border-y border-slate-200/80 bg-slate-50/70 px-6 py-18 dark:border-slate-800 dark:bg-slate-900/30 md:py-20">
        <div className="mx-auto max-w-5xl">
          <h2 className="text-center font-heading text-2xl font-bold text-slate-900 md:text-3xl dark:text-white">{t("pages.featurePages.howItWorks", { ns: "web_pages" })}</h2>
      ...
      <section className="px-6 py-18 md:py-20">
        <div className="mx-auto max-w-3xl">
          <h2 className="text-center font-heading text-2xl font-bold text-slate-900 md:text-3xl dark:text-white">{t("pages.articleChrome.faqLong", { ns: "web_pages" })}</h2>
      ...
      {related.length > 0 ? (
        <section className="border-t border-slate-200/80 px-6 py-16 dark:border-slate-800">
          <div className="mx-auto max-w-5xl">
            <h2 className="text-center font-heading text-xl font-bold text-slate-900 md:text-2xl dark:text-white">{t("pages.featurePages.meetTheRest", { ns: "web_pages" })}</h2>
              ...
              {related.map((r) => {
                ...
                return (
                  ...
                  >
                    ...
                    <span className="mt-2 inline-flex items-center gap-1 text-sm font-semibold text-[#0072ce] dark:text-[#4da3e8]">{t("pages.featurePages.learnMore", { ns: "web_pages" })}<ArrowRight size={14} className="transition group-hover:translate-x-0.5" aria-hidden />
                    </span>
                  </Link>
                );
              })}
      ...
      <section className="px-6 pb-20 pt-4 md:pb-24">
        <div className="mx-auto max-w-4xl rounded-3xl bg-gradient-to-br from-[#0072ce] via-[#4F46E5] to-[#7c3aed] px-8 py-14 text-center text-white shadow-2xl md:px-12">
          <h2 className="font-heading text-2xl font-bold leading-tight md:text-3xl">{t("pages.featurePages.putToWork", { ns: "web_pages" })}</h2>
          <p className="mx-auto mt-4 max-w-xl text-base text-white/90 md:text-lg">
            {feature.name} {t("pages.featurePages.oneMember", { ns: "web_pages" })}</p>
          <div className="mt-8 flex flex-wrap justify-center gap-3">
            ...
            >{t("pages.featurePages.seeAllFeatures", { ns: "web_pages" })}</Link>
          </div>
        </div>
      </section>
    </>
