  ...
  return (
    <main className="mx-auto max-w-6xl px-4 py-10">
      <header className="mb-8 max-w-2xl">
        <h1 className="text-3xl font-bold tracking-tight text-slate-900 sm:text-4xl">{t("pages.homesIndex.h1", { ns: "web_pages" })}</h1>
        <p className="mt-3 text-base text-slate-600">{t("pages.homesIndex.sub", { ns: "web_pages" })}</p>
      </header>
      ...
      >
        <label htmlFor="homes-q" className="sr-only">{t("pages.homesIndex.describeHome", { ns: "web_pages" })}</label>
        ...
        >{t("pages.homesIndex.searchHomes", { ns: "web_pages" })}</button>
      </form>

      <section className="mt-10">
        <h2 className="text-lg font-semibold text-slate-900">{t("pages.homesIndex.popularMarkets", { ns: "web_pages" })}</h2>
        <p className="mt-1 text-sm text-slate-600">{t("pages.homesIndex.browseByCity", { ns: "web_pages" })}</p>
            ...
            return (
              ...
              >
                ...
                <div className="mt-1 text-xs text-slate-600">
                  {t(`pages.homesIndex.cityBlurb.${c.key}`, { ns: "web_pages" })}
                </div>
              </Link>
            );
          })}
      ...
      <section className="mt-12 grid gap-4 rounded-2xl border border-slate-200 bg-white p-6 sm:grid-cols-3">
        <div>
          <div className="text-sm font-semibold text-slate-900">{t("pages.homesIndex.plainEnglish", { ns: "web_pages" })}</div>
          <p className="mt-1 text-xs text-slate-600">{t("pages.homesIndex.plainEnglishBody", { ns: "web_pages" })}</p>
        </div>
        <div>
          <div className="text-sm font-semibold text-slate-900">{t("pages.homesIndex.connectAgent", { ns: "web_pages" })}</div>
          <p className="mt-1 text-xs text-slate-600">{t("pages.homesIndex.connectAgentBody", { ns: "web_pages" })}</p>
        </div>
        <div>
          <div className="text-sm font-semibold text-slate-900">{t("pages.homesIndex.freeToTry", { ns: "web_pages" })}</div>
          <p className="mt-1 text-xs text-slate-600">{t("pages.homesIndex.freeToTryBody", { ns: "web_pages" })}</p>
        </div>
      </section>
      ...
      <footer className="mt-12 border-t border-slate-200 pt-6 pb-10 text-[11px] leading-relaxed text-slate-500">
        ...
        <p className="mt-2">{t("pages.homesIndex.equalHousing", { ns: "web_pages" })}</p>
      </footer>
    </main>
  );
}
