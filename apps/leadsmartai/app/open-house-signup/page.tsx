      ...
      <div className="max-w-xl mx-auto px-4 py-8">
        <div className="bg-white border border-slate-200 rounded-2xl shadow-sm p-6">
          ...
          <form noValidate onSubmit={onSubmit} className="mt-6 space-y-4">
            <div>
              <label className="block text-sm font-semibold text-slate-800">{t("pages.articleChrome.name", { ns: "web_pages" })}</label>
              <input
            ...
            <div>
              <label className="block text-sm font-semibold text-slate-800">{t("pages.articleChrome.email", { ns: "web_pages" })}</label>
              <input
                type="email"
                className="mt-1 w-full rounded-xl border border-slate-300 px-3 py-2 outline-none focus:ring-2 focus:ring-blue-500"
                value={email}
            ...
            <div>
              <label className="block text-sm font-semibold text-slate-800">{t("pages.articleChrome.phone", { ns: "web_pages" })}</label>
              <input
                className="mt-1 w-full rounded-xl border border-slate-300 px-3 py-2 outline-none focus:ring-2 focus:ring-blue-500"
                value={phone}
            ...
            <div className="rounded-xl border border-slate-200 bg-slate-50/60 p-4">
              <label htmlFor="oh-sms-consent" className="flex cursor-pointer items-start gap-3">
                ...
                <span className="text-sm text-slate-700">
                  <span className="font-semibold text-slate-900">{t("pages.homeValueFunnel.smsConsent", { ns: "web_pages" })}</span>{" "}{t("pages.homeValueFunnel.smsConsentBody", { ns: "web_pages" })}{" "}
                  <strong>CloseBoss</strong> {t("pages.homeValueFunnel.smsConsentTail", { ns: "web_pages" })}</span>
              </label>
              <p className="mt-3 pl-7 text-xs leading-relaxed text-slate-500">{t("pages.homeValueFunnel.smsRates", { ns: "web_pages" })}{" "}
                <strong>{t("pages.homeValueFunnel.stop", { ns: "web_pages" })}</strong> {t("pages.homeValueFunnel.toOptOut", { ns: "web_pages" })} <strong>{t("pages.homeValueFunnel.help", { ns: "web_pages" })}</strong> {t("pages.homeValueFunnel.forHelp", { ns: "web_pages" })}{" "}
                <a
                  href="/privacy"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="font-medium text-blue-600 hover:underline"
                >{t("pages.articleChrome.privacyPolicy", { ns: "web_pages" })}</a>{" "}
                ...
                <a
                  ...
                  rel="noopener noreferrer"
                  className="font-medium text-blue-600 hover:underline"
                >{t("pages.articleChrome.termsOfService", { ns: "web_pages" })}</a>{" "}{t("pages.homeValueFunnel.forDetails", { ns: "web_pages" })}</p>
            </div>
