...
export default async function TryDemoPage() {
  ...
  const jsonLd = {
    ...
    "@type": "WebPage",
    name: "Try the live CloseBoss demo",
    url: `${SITE_URL}/try-demo`,
    description:
      "Read-only sandbox of the CloseBoss workspace — inbox, drafts, contacts, calendar.",
  };
    ...
    <div className="min-h-screen bg-white dark:bg-slate-950">
      ...
      <div className="mx-auto max-w-5xl px-4 py-12 md:px-6 md:py-16">
        <header className="text-center">
          <p className="text-xs font-semibold uppercase tracking-[0.18em] text-blue-600 dark:text-blue-400">{t("pages.tryDemo.publicSandbox", { ns: "web_pages" })}</p>
          <h1 className="mt-3 text-3xl font-semibold tracking-tight text-slate-900 md:text-5xl dark:text-white">{t("pages.tryDemo.clickThrough", { ns: "web_pages" })}</h1>
          <p className="mx-auto mt-4 max-w-2xl text-base leading-7 text-slate-600 md:text-lg dark:text-slate-300">{t("pages.tryDemo.noSignup", { ns: "web_pages" })}</p>
          <div className="mt-6 flex flex-wrap justify-center gap-3">
            ...
            >{t("pages.tryDemo.enterDemo", { ns: "web_pages" })}<ArrowRight className="ml-1.5 h-4 w-4" aria-hidden />
            </Link>
            <Link
              href="/start-free"
            ...
            >{t("pages.tryDemo.skipToTrial", { ns: "web_pages" })}</Link>
          </div>
        </header>

        {/* Tour roadmap */}
        <section className="mt-12">
          <h2 className="text-xl font-semibold tracking-tight text-slate-900 md:text-2xl dark:text-white">{t("pages.tryDemo.whereToLook", { ns: "web_pages" })}</h2>
              ...
              <li key={tour.href}>
                ...
                >
                  ...
                  <span className="mt-auto pt-4 text-xs font-semibold text-blue-700 dark:text-blue-300">
                    {t("pages.tryDemo.openTour", { ns: "web_pages" })}
                  </span>
                </Link>
              </li>
            ))}
        ...
        <section className="mt-16 grid gap-5 rounded-3xl border border-blue-100 bg-gradient-to-br from-blue-50 via-white to-white p-6 md:grid-cols-2 md:p-10 dark:border-blue-900/40 dark:from-blue-950/30 dark:via-slate-950 dark:to-slate-950">
          <div>
            <p className="text-xs font-semibold uppercase tracking-[0.18em] text-blue-700 dark:text-blue-300">{t("pages.tryDemo.whatsReal", { ns: "web_pages" })}</p>
            <h2 className="mt-2 text-lg font-semibold tracking-tight text-slate-900 md:text-xl dark:text-white">{t("pages.tryDemo.whatsRealBody", { ns: "web_pages" })}</h2>
          ...
          <div>
            <p className="text-xs font-semibold uppercase tracking-[0.18em] text-slate-500 dark:text-slate-400">{t("pages.tryDemo.whatsSandboxed", { ns: "web_pages" })}</p>
            <h2 className="mt-2 text-lg font-semibold tracking-tight text-slate-900 md:text-xl dark:text-white">{t("pages.tryDemo.whatsSandboxedBody", { ns: "web_pages" })}</h2>
            <ul className="mt-3 space-y-2 text-sm text-slate-700 dark:text-slate-200">
              {[
        ...
        <section className="mt-12 rounded-2xl border border-slate-200 bg-slate-50 p-6 text-center md:p-8 dark:border-slate-800 dark:bg-slate-900/40">
          <h2 className="text-lg font-semibold tracking-tight text-slate-900 md:text-xl dark:text-white">{t("pages.tryDemo.readyForReal", { ns: "web_pages" })}</h2>
          <p className="mx-auto mt-2 max-w-xl text-sm leading-6 text-slate-600 dark:text-slate-300">
            {t("pages.tryDemo.trialNote", { ns: "web_pages" })}
          </p>
          <div className="mt-5 flex flex-wrap justify-center gap-3">
            <Link
              href="/start-free"
              className="inline-flex items-center justify-center rounded-md bg-blue-600 px-5 py-2.5 text-sm font-semibold text-white shadow-sm transition hover:bg-blue-700"
            >{t("pages.tryDemo.startTrial", { ns: "web_pages" })}</Link>
            <Link
              href="/switch-from"
              className="inline-flex items-center justify-center rounded-md border border-blue-200 bg-white px-5 py-2.5 text-sm font-semibold text-blue-700 transition hover:bg-blue-50 dark:border-blue-900/50 dark:bg-slate-900 dark:text-blue-300 dark:hover:bg-slate-900/70"
            >{t("pages.tryDemo.migrateFrom", { ns: "web_pages" })}</Link>
          </div>
        </section>
      </div>
    </div>
