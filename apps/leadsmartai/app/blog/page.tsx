    ...
    <div className="min-h-screen bg-white dark:bg-slate-950">
      ...
      <div className="mx-auto max-w-6xl px-4 py-12 md:px-6 md:py-16">
        <header className="text-center">
          <p className="text-xs font-semibold uppercase tracking-[0.18em] text-blue-600 dark:text-blue-400">{t("pages.blogIndex.h1", { ns: "web_pages" })}</p>
          <h1 className="mt-3 text-3xl font-semibold tracking-tight text-slate-900 md:text-5xl dark:text-white">{t("pages.blogIndex.tagline", { ns: "web_pages" })}</h1>
          <p className="mx-auto mt-4 max-w-2xl text-base leading-7 text-slate-600 md:text-lg dark:text-slate-300">{t("pages.blogIndex.sub", { ns: "web_pages" })}</p>
        </header>

        {featured ? <FeaturedCard post={featured} locale={locale} /> : null}

        <section className="mt-12">
          <h2 className="text-xl font-semibold tracking-tight text-slate-900 md:text-2xl dark:text-white">{t("pages.blogIndex.latestPosts", { ns: "web_pages" })}</h2>
        ...
        <section className="mt-16 rounded-2xl border border-slate-200 bg-slate-50 p-6 text-center dark:border-slate-800 dark:bg-slate-900/40 md:p-8">
          <h2 className="text-lg font-semibold text-slate-900 md:text-xl dark:text-white">{t("pages.blogIndex.wantEveryPost", { ns: "web_pages" })}</h2>
          <p className="mx-auto mt-2 max-w-xl text-sm leading-6 text-slate-600 dark:text-slate-300">{t("pages.blogIndex.wantEveryPostBody", { ns: "web_pages" })}</p>
          <div className="mt-5 flex flex-wrap justify-center gap-3">
            ...
            >{t("pages.blogIndex.startTrial", { ns: "web_pages" })}</Link>
            <Link
              href="/agent/compare"
            ...
            >{t("pages.blogIndex.compareCrm", { ns: "web_pages" })}</Link>
          </div>
        </section>
      </div>
    </div>
        ...
        <div className="grid gap-8 p-6 md:grid-cols-[1.2fr_1fr] md:gap-12 md:p-10">
          <div>
            <div className="flex flex-wrap items-center gap-2 text-[11px] font-semibold uppercase tracking-wider">
              <span className="inline-flex items-center rounded-full bg-blue-600 px-2.5 py-1 text-white">{t("pages.blogIndex.featured", { ns: "web_pages" })}</span>
              ...
              <span className="text-slate-500 dark:text-slate-400">
                {t("pages.blogPost.readTime", { time: post.readTime, ns: "web_pages" })}
              </span>
            </div>
            ...
            <span className="mt-6 inline-flex items-center gap-1.5 text-sm font-semibold text-blue-700 dark:text-blue-300">{t("pages.blogIndex.readThePost", { ns: "web_pages" })}<svg
                aria-hidden
          ...
          <div className="relative hidden overflow-hidden rounded-2xl border border-slate-200 bg-white p-6 md:block dark:border-slate-800 dark:bg-slate-900">
            <div className="space-y-2 text-sm text-slate-500 dark:text-slate-400">
              <p className="text-[10px] font-semibold uppercase tracking-wider text-blue-600 dark:text-blue-300">{t("pages.blogIndex.quickTake", { ns: "web_pages" })}</p>
