...
const SECTIONS: Array<{ headingKey: string; body: (t: Translate) => ReactNode }> = [
  {
    ...
    body: (t) => (
      <>
        {t("pages.callYourSphere.everyCrmEnds", { ns: "web_pages" })} <em>{t("pages.callYourSphere.conversationWord", { ns: "web_pages" })}</em>{" "}
        {t("pages.callYourSphere.endsTail", { ns: "web_pages" })}
      </>
    ),
  },
  {
    ...
    body: (t) => (
      <>
        {t("pages.callYourSphere.actuallyCalls", { ns: "web_pages" })}{" "}
        <strong>{t("pages.callYourSphere.receptionist", { ns: "web_pages" })}</strong> {t("pages.callYourSphere.answersLive", { ns: "web_pages" })}{" "}
        <strong>{t("pages.callYourSphere.placesRealCalls", { ns: "web_pages" })}</strong>{t("pages.callYourSphere.outboundTail", { ns: "web_pages" })}
      </>
    ),
  },
  {
    ...
    body: (t) => (
      <>
        {t("pages.callYourSphere.youreTheBoss", { ns: "web_pages" })}{" "}
        <strong>{t("pages.callYourSphere.bossAssistant", { ns: "web_pages" })}</strong> {t("pages.callYourSphere.figuresOut", { ns: "web_pages" })}
      </>
    ),
  },
  {
    headingKey: "pages.callYourSphere.h4Section",
    body: (t) => <>{t("pages.callYourSphere.sayExample", { ns: "web_pages" })}</>,
  },
];
    ...
    <div className="min-h-screen bg-white dark:bg-slate-950">
      ...
      <article className="mx-auto max-w-3xl px-4 py-12 md:px-6 md:py-16">
        <nav aria-label={t("pages.articleChrome.breadcrumb", { ns: "web_pages" })} className="mb-6 text-xs text-slate-500 dark:text-slate-400">
          ...
          <Link href="/blog" className="hover:text-slate-700 dark:hover:text-slate-200">{t("pages.callYourSphere.blog", { ns: "web_pages" })}</Link>
          <span className="mx-2">/</span>
          <span className="text-slate-700 dark:text-slate-300">{t("pages.callYourSphere.crumb", { ns: "web_pages" })}</span>
        </nav>

        <header>
          <div className="flex flex-wrap items-center gap-2 text-[11px] font-semibold uppercase tracking-wider">
            <span className="inline-flex items-center rounded-full bg-blue-600/10 px-2.5 py-1 text-blue-700 dark:bg-blue-500/15 dark:text-blue-300">{t("pages.callYourSphere.category", { ns: "web_pages" })}</span>
          ...
          <p className="mt-4 text-base leading-7 text-slate-600 md:text-lg dark:text-slate-300">{t("pages.callYourSphere.subtitle", { ns: "web_pages" })}</p>
        ...
        <div className="mt-12 rounded-2xl bg-gradient-to-br from-[#0072ce] via-[#4F46E5] to-[#7c3aed] p-8 text-center text-white">
          <h2 className="text-2xl font-bold">{t("pages.callYourSphere.ctaTitle", { ns: "web_pages" })}</h2>
          <p className="mx-auto mt-2 max-w-md text-sm text-white/90">{t("pages.callYourSphere.ctaBody", { ns: "web_pages" })}</p>
          <div className="mt-6 flex flex-wrap justify-center gap-3">
            ...
            >{t("pages.callYourSphere.hireTeam", { ns: "web_pages" })}</Link>
            <Link
              href="/features"
            ...
            >{t("pages.callYourSphere.seeHow", { ns: "web_pages" })}</Link>
          </div>
        </div>
      </article>
    </div>
