...
import { DEFAULT_ASSISTANT_AVATARS, defaultAvatarForType } from "@/lib/closeboss/avatars";
import {
 ...
 * from the lib/closeboss/team.ts roster so existing agents pick up
