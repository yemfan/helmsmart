...
const agentCopy: LandingCopy = {
  hero: {
    ...
    line3: "CloseBoss captures, qualifies, and follows up with your leads — instantly.",
  ...
  solution: {
    ...
    title: "CloseBoss is a Deal Conversion Engine.",
  ...
  valueStack: {
    title: "Why Agents Choose CloseBoss",
    benefits: [
...
const brokerCopy: LandingCopy = {
  ...
  valueStack: {
    title: "Why Brokers Choose CloseBoss",
    benefits: [
