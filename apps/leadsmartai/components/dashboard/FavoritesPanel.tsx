  ...
  return (
    <section className="rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 p-5">
      <div className="flex items-center justify-between gap-3">
        <div>
          <h2 className="text-sm font-semibold text-slate-900 dark:text-slate-100">{t("pages.favorites.title")}</h2>
        ...
        <ul className="mt-3 grid gap-2 sm:grid-cols-2">
          {favorites.map((f) => (
            ...
            >
              ...
              <div className="p-2">
                <div className="text-sm font-semibold text-slate-900 dark:text-slate-100">{money(f.price)}</div>
