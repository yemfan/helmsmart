        ...
        >
          <div className="w-full max-w-md rounded-2xl bg-white p-5 shadow-xl">
            <div className="flex items-start justify-between gap-3">
              <div>
                <h2 className="text-base font-semibold text-slate-900">{t("pages.generateCma.title")}</h2>
            ...
            <label className="mt-4 block">
              <span className="text-xs font-semibold text-slate-700">{t("pages.generateCma.subjectAddress")}</span>
              <input
                type="text"
                value={address}
