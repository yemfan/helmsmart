        ...
        <div className="flex flex-wrap gap-1.5">
          {WINDOW_OPTIONS.map((w) => (
            <button
              ...
              className={`rounded-full px-3 py-1 text-xs font-semibold ring-1 transition ${ windowDays === w.days ? "bg-[#0072ce] text-white ring-slate-900" : "bg-white dark:bg-slate-900 text-slate-700 dark:text-slate-300 ring-slate-200 hover:bg-slate-50 dark:hover:bg-slate-800" }`}
            >
              {w.label}
            </button>
          ))}
