              ...
              >
                ...
                >
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    {r.closingAddress ? (
                      <p className="mt-0.5 truncate text-[11px] text-slate-500">{t("pages.dashFragments.currentlyAt")} {r.closingAddress}
                      </p>
                    ) : null}
                  </div>
                </Link>
...
function ScoreBadge({ score, label }: { score: number; label: BuyerPredictionLabel }) {
  ...
  return (
    <div
      ...
      aria-label={t("pages.likelyBuyers.scoreAria", { label: t(`pages.likelyBuyers.label${label.charAt(0).toUpperCase()}${label.slice(1)}`), score })}
    >
